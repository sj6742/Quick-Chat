...
import { Users, Bell, ArrowLeft } from "lucide-react";
...
const Sidebar = ({ isSidebarVisible, setSidebarVisible }) => {
  ...
  return (
    <aside
      className={`fixed inset-y-0 left-0 h-full z-50 bg-gray-900 transition-transform duration-300 
        ${isSidebarVisible ? "translate-x-0" : "-translate-x-full"} lg:relative lg:translate-x-0 lg:w-72 border-r border-gray-700 shadow-lg p-4 flex flex-col`}
    >
      {/* Sidebar Header */}
      <div className="border-b border-gray-700 pb-4 w-full flex items-center justify-between">
