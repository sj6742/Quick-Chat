...
const Sidebar = () => {
  ...
  return (
    <aside 
      className={`h-full ${selectedUser ? 'hidden lg:block' : 'block'} w-20 lg:w-72 border-r border-gray-700 bg-gradient-to-br ${gradientThemes[themeIndex]} shadow-lg backdrop-blur-md p-4 flex flex-col transition-all duration-200 relative`}
    >
      {/* Sidebar Header */}
